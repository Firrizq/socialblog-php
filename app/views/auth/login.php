...
<head>
    ...
    <title><?= htmlspecialchars($data['title'] ?? 'Sign In - EmeraldInk') ?></title>
    ...
    <div class="w-full max-w-md">
        ...
        <div class="bg-surface-container-low border border-outline-variant/30 rounded-2xl p-7 sm:p-9 shadow-xl backdrop-blur-md">
            ...
            <?php if (!empty($data['success'])): ?>
                <div class="mb-5 p-3.5 rounded-xl bg-primary-container/20 border border-primary/40 text-primary text-sm flex items-start gap-2.5">
            ...
            <form action="<?= BASEURL ?>/auth/login" method="POST" class="space-y-4">
                ...
                <div>
                    <div class="flex items-center justify-between mb-1.5">
                        <label for="password" class="font-label-md text-xs uppercase tracking-wider text-on-surface-variant font-medium">
                            Password
                        </label>
                    </div>
                    <div class="relative flex items-center">
            ...
            <div class="mt-6 pt-5 border-t border-outline-variant/30 text-center">
                <p class="font-body-md text-sm text-on-surface-variant">
                    ...
                    <a href="<?= BASEURL ?>/auth/register" class="text-primary hover:text-primary-fixed font-semibold transition-colors ml-1">
                        Create Account
                    </a>
                </p>
            </div>
